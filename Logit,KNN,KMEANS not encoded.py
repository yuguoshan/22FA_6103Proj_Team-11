...
# %%
plt.scatter( df[y==0].iloc[:,index1], df[y==0].iloc[:,index2], s=50, c='lightgreen', marker='s', edgecolor='black', label='No' )

plt.scatter( df[y==1].iloc[:,index1], df[y==1].iloc[:,index2], s=50, c='orange', marker='o', edgecolor='black', label='Yes' )
